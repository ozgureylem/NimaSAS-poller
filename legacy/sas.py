...
# -*- coding: utf8 -*-
#
# LEGACY / REFERENCE ONLY. Python 2, does not run as-is. Kept only as a
# command-code and byte-count inventory for the saspy/ rewrite; several of
# its field offsets and error-handling patterns are confirmed wrong against
# the SAS 6.02 spec (see README.md). Do not copy parsing logic from this
# file without re-checking it against the spec tables.
import bcd
import serial
import time
import binascii
