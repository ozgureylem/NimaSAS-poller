...
# -*- coding: utf8 -*-
#
# LEGACY / REFERENCE ONLY. Python 2, a manual hardware-in-the-loop script
# rather than an automated test suite. See tests/ for the current test
# suite (runs against fake serial ports, no hardware required).
